...
if ($id_pelanggan) {
    ...
    $params_total_kue[':id_pelanggan'] = $id_pelanggan;
}

// Filter jenis kue
if ($id_jenis_kue) {
    $sql_total_kue .= " AND d.id_jenis_kue = :id_jenis_kue";
    $params_total_kue[':id_jenis_kue'] = $id_jenis_kue;
}

$stmt = $db->prepare($sql_total_kue);
$stmt->execute($params_total_kue);
$total_kue_pcs = $stmt->fetch(PDO::FETCH_ASSOC)['total_kue_pcs'] ?? 0;
